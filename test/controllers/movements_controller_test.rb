...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post movements_url, params: { movement: { crypto_id: @movement.crypto_id, date: @movement.date, operation: @movement.operation, price: @movement.price, quantity: @movement.quantity } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { crypto_id: @movement.crypto_id, date: @movement.date, operation: @movement.operation, price: @movement.price, quantity: @movement.quantity } }
